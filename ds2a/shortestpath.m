...
% Find relation of every nodes(except the startpoint so that n-1) to the start point.
  for i = 1:(n - 1),
   ...
   tmp_vector(1:n) = inf;
   % Add the value under the index in dist to tmprary vector
...
disp("The shortest path: ");disp(path);
disp("The distance: ");


end;   % End the if-else sats.
